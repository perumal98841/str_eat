...
module "prod_angular_iam_policy_ecr" {
  source = "../../modules/iam_role_policy"
  policy_name = "prod_angular_iam_policy_ecr"
  policy = data.aws_iam_policy_document.angular_ecr_policy.json
  role = module.prod_angular_iam_role.id
}

module "prod_angular_iam_policy_logs" {
  source = "../../modules/iam_role_policy"
  policy_name = "prod_angular_iam_policy_logs"
