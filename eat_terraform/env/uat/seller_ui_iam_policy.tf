...
module "uat_seller_ui_iam_policy_ecr" {
  source = "../../modules/iam_role_policy"
  policy_name = "uat_seller_ui_iam_policy_ecr"
  policy = data.aws_iam_policy_document.seller_ui_ecr_policy.json
  role = module.uat_seller_ui_iam_role.id
}

module "uat_seller_ui_iam_policy_logs" {
  source = "../../modules/iam_role_policy"
  policy_name = "uat_seller_ui_iam_policy_logs"
